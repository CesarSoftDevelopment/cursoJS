/**
 * Atributos privados só conseguimos acessá-los dentro da função Pessoa, fora não consegue
 * let os métodos são privados
 * this os métodos são públicos
 */
...
function Pessoa(n, s, raca = 'Humano'){
    // atributos privados só conseguimos fazer uso da função construtora
    let altura = 0.30;
    let peso = 0.5;
    let idade = 0;
    let nome = n;
    ...
    //podemos acessar fora da função 
...
console.log(angelina.peso); //não tenho acesso
console.log(angelina.raca); //público

angelina.fazer_aniversario(); //público

//Instanciar um novo objeto
const felicity = new Pessoa("Felicity");
